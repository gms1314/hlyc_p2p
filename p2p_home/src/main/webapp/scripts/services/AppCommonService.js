var option = {
    'url':{
        'api_user':'/p2p_action/user/', //用户相关
        'api_investment':'/p2p_action/investment/', 
        'api_productRate':'/p2p_action/productRate/',
        'api_product':'/p2p_action/product/', 
        'api_productAccount':'/p2p_action/productaccount/',
        'api_acount':'/p2p_action/account/',
        'api_verification':'/p2p_action/verification/',
        'api_emailAuth':'/p2p_action/emailAuth/',
        'api_paymentpwd':'/p2p_action/paymentpwd/',
        'api_extracts':'/p2p_action/extracts/',  //提现与支付功能
        'api_bankcardInfo':'/p2p_action/bankCardInfo/',
        'api_charges':'/p2p_action/charges/'
    },
    'header':{
        'headers':{
        ...
        return {
           ...
           //注册校验验证码的正确性
            ...
            personCenter:function($str){
                ...
                // /p2p_action/user/accountHomepage
            },
